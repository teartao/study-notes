package com.neotao.reliable.receive.consumer;
...
public class ConsumerConfig {
    ...
    @Bean("queue")
    public Queue queue() {
        return new Queue("RELIABLE_RECEIVE_QUEUE", true, false, false, new HashMap<>());
    }
    ...
    public Binding binding(@Qualifier("queue") Queue queue, @Qualifier("exchange") DirectExchange exchange) {
        return BindingBuilder.bind(queue).to(exchange).with("reliable.test");
    }
    ...
    public MessageListenerContainer messageListenerContainer(ConnectionFactory connectionFactory) {
        ...
        messageListenerContainer.setQueueNames("RELIABLE_RECEIVE_QUEUE");
