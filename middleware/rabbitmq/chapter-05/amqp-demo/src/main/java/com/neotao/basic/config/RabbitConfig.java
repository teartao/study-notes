package com.neotao.basic.config;
...
public class RabbitConfig {
    ...
    public TopicExchange getTopicExchange() {
        return new TopicExchange("BASIC_TOPIC_EXCHANGE");
    }

    @Bean("fanoutExchange")
    public FanoutExchange getFanoutExchange() {
        return new FanoutExchange("BASIC_FANOUT_EXCHANGE");
    }
    ...
    public Queue getFirstQueue() {
        ...
        Queue queue = new Queue("BASIC_FIRST_QUEUE", false, false, true, args);
        return queue;
    }
